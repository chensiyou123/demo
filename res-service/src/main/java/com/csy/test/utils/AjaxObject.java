...
public class AjaxObject extends HashMap<String, Object> {
	...
	public static AjaxObject error() {
		return error(org.apache.commons.httpclient.HttpStatus.SC_INTERNAL_SERVER_ERROR, "未知异常，请联系管理员");
	}

	public static AjaxObject error(String msg) {
		return error(org.apache.commons.httpclient.HttpStatus.SC_INTERNAL_SERVER_ERROR, msg);
	}
